...
class Scene3(Scene):
    def construct(self):
        ...
        group = VGroup(text3, diagram_img)
        group.arrange(DOWN)
        group.set_height(config.frame_height * 0.8)
        group.move_to(ORIGIN)
...
class Scene4(Scene):
    def construct(self):
        ...
        group = VGroup(text2, diagram_img)
        group.arrange(DOWN)
        group.set_height(config.frame_height * 0.8)
        group.move_to(ORIGIN)
...
class Scene5(Scene):
    def construct(self):
        ...
        text2.set_width(config.frame_width * 0.8)
        group2 = VGroup(text2, image1.copy())
        group2.arrange(DOWN)
        ...
        text3.set_width(config.frame_width * 0.8)
        group3 = VGroup(text3, image1.copy())
        group3.arrange(DOWN)
...
class Scene6(Scene):
    def construct(self):
        ...
        group4 = VGroup(text4, image1.copy())
        group4.arrange(DOWN)
